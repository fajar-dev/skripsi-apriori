  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content shadow rounded">
      ...
      <div class="modal-footer flex-nowrap p-0">
        <button type="button" class="btn-delete-oke btn btn-lg btn-secondary bg-transparent fs-6 text-decoration-none col-6 m-0 rounded-0 border-end">Delete</button>
        <button type="button" class="btn btn-lg btn-secondary bg-transparent fs-6 text-decoration-none col-6 m-0 rounded-0" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered bg-transparent shadow-none">
    <div class="modal-content bg-transparent shadow-none">
      <div class="modal-body text-center">
        <div class="spinner-border text-primary bg-body p-5" role="status">
